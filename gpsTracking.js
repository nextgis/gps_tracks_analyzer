...
function tabulate(parentNode, data, columns, headers) {
	...
	.append("td")
	.html(function(d) {
		if (d.column == 'track_data') { return '<image class="icon" src="data:image/png;base64,">'; }
		else { return d.value; }
	 })
